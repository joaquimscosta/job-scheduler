...
alter table qrtz_job_details owner to "job-scheduler";
...
alter table qrtz_triggers owner to "job-scheduler";
...
alter table qrtz_simple_triggers owner to "job-scheduler";
...
alter table qrtz_cron_triggers owner to "job-scheduler";
...
alter table qrtz_simprop_triggers owner to "job-scheduler";
...
alter table qrtz_blob_triggers owner to "job-scheduler";
...
alter table qrtz_calendars owner to "job-scheduler";
...
alter table qrtz_paused_trigger_grps owner to "job-scheduler";
...
alter table qrtz_fired_triggers owner to "job-scheduler";
...
alter table qrtz_scheduler_state owner to "job-scheduler";
...
alter table qrtz_locks owner to "job-scheduler";
